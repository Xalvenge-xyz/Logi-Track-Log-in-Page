...
The current version of this project focuses on a login system prototype built using PHP, HTML, and CSS, in compliance with the instructor’s requirements.
...
To apply server-side scripting using PHP

To design a simple and functional login interface
...
PHP – Server-side logic and authentication handling
...
Basic authentication logic using PHP
...
✅ JavaScript integration for improved interactivity and validation

✅ Database integration (MySQL) for storing user accounts

✅ User Registration (Sign Up) system

✅ Google Account Authentication (OAuth login)
